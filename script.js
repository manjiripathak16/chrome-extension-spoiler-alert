...
chrome.storage.sync.get({
    ...
    replacePageWords(items.keywordsArray); //pass an array or object that we are going to save
  ...
  function replaceWord(obj){
    var allElements = document.querySelectorAll('h1, h2, h3, h4, h5, p, a, caption, button, image, meta, span, td');
